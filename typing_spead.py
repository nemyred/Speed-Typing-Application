...
class Typing:
    ...
    def __init__(self):
        ...
        self.window.configure(padx=30, pady=10, bg="#000000")

        # Application's widgets
        self.difficulty_label = CTkLabel(self.window)
        self.generated_text = Text(self.window)
        self.entry_field = CTkEntry(self.window)
        self.entry = CTkEntry(self.window)
        self.mist_value = CTkLabel(self.window)
        self.wpm_value = CTkLabel(self.window)
        self.cpm_value = CTkLabel(self.window)
    ...
    def choose_difficulty(self):
        ...
        self.difficulty_label = Label(text="SELECT YOUR DIFFICULTY", font=("Helveltica", 25, "bold"), width=40,
                                      height=2, bg="#2d74b5", fg="#fafafa")
        ...
        info = Button(text="INSTRUCTION", font=("Tahoma", 12, "bold"), bg="#2d74b5", fg="#000000",
    ...
    def create_widgets(self):
        ...
        entry_label.grid(column=1, row=5, sticky=W)
        ...
        self.entry_field = Entry(self.window, width=95, textvariable=self.entry, bg="#242424", fg="#fafafa",
                                 font=("Arial", 16, "bold"))
        self.entry_field.grid(column=1, row=6, columnspan=8, pady=15, ipady=0, sticky=W)
        self.entry_field.bind("<BackSpace>", self.backspace)

        # restart button
        restart = Button(self.window, text="RESTART", font=("Tahoma", 12, "bold"), bg="#000000", fg="#fafafa",
